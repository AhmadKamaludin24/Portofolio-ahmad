          ...
          <div className="dark:bg-gradient-to-r dark:from-gray-900 dark:to-blue-500">
            <div className="container-certificate">
              ...
              >
                ...
                <SwiperSlide>
                  <Link href="/images/certificate/1.png">
                    <Image src="/images/certificate/1.png" alt="picture3" width={500} height={500} />
                  </Link>
                </SwiperSlide>
                <SwiperSlide>
                  <Link href="/images/certificate/1.png">
                    <Image src="/images/certificate/1.png" alt="picture2" width={500} height={500} />

                  </Link>
                </SwiperSlide>
                <SwiperSlide>
                  <Link href="/images/certificate/1.png">
                    <Image src="/images/certificate/1.png" alt="picture4" width={500} height={500} />
                  </Link>
                </SwiperSlide>
                <SwiperSlide>
                  <Link href="/images/certificate/1.png">
