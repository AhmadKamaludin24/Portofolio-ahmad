...
export default function About() {
  ...
  return (
    <>
      <TheHead title="About | Ahmad kamaludin" />
        ...
        <div className="w-screen">
          <section>
              ...
              <div className="flex justify-center sm:justify-end">
                <div className="absolute w-80 -mt-8 bg-white border border-gray-200 rounded-lg shadow p-6 sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <ul className="my-4 space-y-3">
                    ...
                    <li>
                      <Link href="https://www.instagram.com/endrajanu_brajatikswa/" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        <RiInstagramFill className=" text-red-500" />
                        <span className="flex-1 ml-3 whitespace-nowrap">Instagram</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="https://www.linkedin.com/in/ahmad-kamaludin-098826298" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        <AiFillLinkedin className="text-blue-600"/>
                        <span className="flex-1 ml-3 whitespace-nowrap">Linkedin</span>
                      </Link>
                    </li>
                    <li>
                      <Link href="https://github.com/AhmadKamaludin24" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        <AiFillGithub />
            ...
            <div className="text-center sm:text-start space-y-5 text-dark dark:text-gray-400">
              ...
              <p>
                This website is my platform to share insights, experiences and discoveries from my journey as an student. Join me as we dive into the ever-exciting world of technology, where every line of code has the potential to advance digital development in incredible ways.
              </p>
              <p>
