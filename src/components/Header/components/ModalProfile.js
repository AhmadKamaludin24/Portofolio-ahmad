      ...
      <ModalBody className="dark:bg-gray-900">
        ...
        <Card className="dark:bg-gray-900">
          <CardBody className="gap-2 text-dark dark:text-gray-300">
            <Button
              href="https://wa.me/6289512002665/"
              color="default"
              variant="bordered"
              endContent={<HiOutlineChat className="text-dark dark:text-gray-300" />}
            >
              <Link href="https://wa.me/6289512002665/">Messages</Link>
            </Button>

            <Button
              href="https://saweria.co/AhmadKamaludin24"
              color="default"
              variant="bordered"
              endContent={<HiGift className="text-dark dark:text-gray-300" />}
            >
              <Link href="https://saweria.co/AhmadKamaludin24">Coffee Time</Link>
            </Button>
          </CardBody>
        </Card>
      </ModalBody >
